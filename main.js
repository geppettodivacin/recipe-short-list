...
var $author$project$Main$Section = function (a) {
	return {$: 'Section', a: a};
};
var $author$project$Main$Recipe = function (a) {
	return {$: 'Recipe', a: a};
};
var $author$project$Main$initBreakfasts = _List_fromArray(
	[
		$author$project$Main$Recipe(
		{title: 'Breakfast Risotto', url: ''}),
		$author$project$Main$Recipe(
		...
		$author$project$Main$Recipe(
		{title: 'Peanut Butter Oatmeal Bars', url: 'https://reneenicoleskitchen.com/no-bake-peanut-butter-honey-oat-bars/'}),
		$author$project$Main$Recipe(
		{title: 'Peanut Butter Overnight Oats', url: 'https://dessertsandsweets.com/peanut-butter-overnight-oats-recipe/'})
	]);
var $author$project$Main$initDesserts = _List_fromArray(
	[
		$author$project$Main$Recipe(
		{title: 'Bread Pudding', url: 'https://tornadoughalli.com/the-best-bread-pudding/'}),
		$author$project$Main$Recipe(
		{title: 'Creamy Peanut Butter Pie', url: 'https://www.browneyedbaker.com/wprm_print/47132'}),
		$author$project$Main$Recipe(
		{title: 'Frozen Yogurt Bark', url: 'https://iheartvegetables.com/chocolate-peanut-butter-frozen-yogurt-bark/'}),
		$author$project$Main$Recipe(
		{title: 'Greek Yogurt Bark', url: 'https://www.wellseasonedstudio.com/greek-yogurt-bark/'}),
		$author$project$Main$Recipe(
		{title: 'Homemade Cinnamon Roll Cake', url: 'https://www.thecountrycook.net/cinnamon-roll-cake/'}),
		$author$project$Main$Recipe(
		{title: 'No Bake Cookie', url: 'https://www.twopeasandtheirpod.com/no-bake-cookies/'}),
		$author$project$Main$Recipe(
		{title: 'No Bake Reese\'s Peanut Butter Cup Cheesecake', url: 'https://www.thereciperebel.com/no-bake-reeses-peanut-butter-cup-cheesecake-recipe-video/'}),
		$author$project$Main$Recipe(
		{title: 'Peanut Butter Sheet Cake', url: 'https://www.sixcleversisters.com/the-perfect-peanut-butter-sheet-cake/'})
	]);
var $author$project$Main$initDinners = _List_fromArray(
	[
		$author$project$Main$Recipe(
		{title: 'BBQ Pulled Pork', url: 'https://butterwithasideofbread.com/slow-cooker-bbq-pulled-pork/'}),
		$author$project$Main$Recipe(
		{title: 'Best Classic Stuffed Peppers', url: 'https://kristineskitchenblog.com/stuffed-peppers/'}),
		$author$project$Main$Recipe(
		{title: 'Chicken Fajita Casserole', url: 'http://joyfilledeats.com/chicken-fajita-casserole/'}),
		$author$project$Main$Recipe(
		{title: 'Chicken Fajita Soup', url: 'https://www.aspicyperspective.com/skinny-chicken-fajita-soup/#recipe'}),
		$author$project$Main$Recipe(
		{title: 'Chicken Souvlaki', url: 'https://www.chefdehome.com/recipes/772/chicken-souvlaki'}),
		$author$project$Main$Recipe(
		{title: 'Classic Homemade Chili', url: 'https://tastesbetterfromscratch.com/classic-homemade-chili/'}),
		$author$project$Main$Recipe(
		{title: 'Creamy Cajun Chicken and Sausage Pasta', url: 'https://whatmollymade.com/one-pot-creamy-cajun-chicken-pasta/'}),
		$author$project$Main$Recipe(
		{title: 'Creamy Mediterranean Chicken Dinner', url: 'https://www.kyleecooks.com/creamy-mediterranean-chicken-skillet/'}),
		$author$project$Main$Recipe(
		{title: 'Crock Pot Taco Soup', url: 'https://www.beyerbeware.net/crock-pot-low-carb-taco-soup/'}),
		$author$project$Main$Recipe(
		{title: 'Crockpot Potato Soup', url: 'https://www.simplejoy.com/crockpot-potato-soup-recipe/'}),
		$author$project$Main$Recipe(
		{title: 'Fried Rice', url: 'https://spaceshipsandlaserbeams.com/better-than-take-out-fried-rice/'}),
		$author$project$Main$Recipe(
		{title: 'Garlic Butter Quinoa', url: 'https://www.lordbyronskitchen.com/garlic-butter-quinoa/'}),
		$author$project$Main$Recipe(
		{title: 'Ground Beef & Pasta Skillet', url: 'https://www.eatingwell.com/recipe/258448/ground-beef-pasta-skillet/?utm_source=pinterest.com&utm_medium=social&utm_campaign=social-share-recipe&utm_content=20210808&utm_term=258448'}),
		$author$project$Main$Recipe(
		{title: 'Ground Beef Stroganoff', url: 'https://togetherasfamily.com/easy-ground-beef-stroganoff/'}),
		$author$project$Main$Recipe(
		{title: 'Homemade Classic Chili', url: ''}),
		$author$project$Main$Recipe(
		{title: 'Honey Butter Chicken', url: 'https://realhousemoms.com/honey-butter-chicken/'}),
		$author$project$Main$Recipe(
		{title: 'Honey Garlic Glazed Salmon', url: 'https://www.thechunkychef.com/honey-garlic-glazed-salmon/'}),
		$author$project$Main$Recipe(
		{title: 'Instant Pot Beef Stew', url: 'https://thefoodieandthefix.com/21-day-fix-instant-pot-beef-stew/'}),
		$author$project$Main$Recipe(
		{title: 'Instant Pot Keto Tuscan Soup', url: 'https://www.eatwell101.com/instant-pot-keto-tuscan-soup-recipe'}),
		$author$project$Main$Recipe(
		{title: 'Keto Lasagna Soup', url: 'https://slimmingviolet.com/keto-crockpot-recipes/'}),
		$author$project$Main$Recipe(
		{title: 'Loaded Chicken and Potatoes Casserole', url: 'http://www.stockpilingmoms.com/2013/08/loaded-chicken-and-potatoes-casserole/'}),
		$author$project$Main$Recipe(
		{title: 'Low Carb Cheeseburger Bites', url: 'https://masonfit.com/healthy-cheeseburger-bites/'}),
		$author$project$Main$Recipe(
		{title: 'Low Carb Meatloaf', url: 'http://the-lowcarb-diet.com/low-carb-meatloaf/#_a5y_p=2774853'}),
		$author$project$Main$Recipe(
		{title: 'Million Dollar Chicken Bake', url: 'https://easyfamilyrecipes.com/million-dollar-chicken-bake/'}),
		$author$project$Main$Recipe(
		{title: 'One Pot Creamy Cajun Chicken Pasta [Dairy Free]', url: 'https://whatmollymade.com/one-pot-creamy-cajun-chicken-pasta/'}),
		$author$project$Main$Recipe(
		{title: 'Pizza Dough', url: 'https://bellyfull.net/quick-and-easy-pizza-dough/'}),
		$author$project$Main$Recipe(
		{title: 'Pollo con Queso', url: 'https://farmlifediy.com/pollo-con-queso-low-carb-keto/'}),
		$author$project$Main$Recipe(
		{title: 'Queso Soup', url: 'https://farmlifediy.com/queso-soup/'}),
		$author$project$Main$Recipe(
		{title: 'Shakshuka ', url: 'https://www.themediterraneandish.com/shakshuka-recipe/'}),
		$author$project$Main$Recipe(
		{title: 'Shrimp & Sausage Skillet', url: 'https://www.paleonewbie.com/20-minute-shrimp-sausage-paleo-skillet-meal/'}),
		$author$project$Main$Recipe(
		{title: 'Slow Cooker Chicken Burrito Bowls', url: 'https://www.thekitchn.com/recipe-slow-cooker-chicken-burrito-bowls-207333'}),
		$author$project$Main$Recipe(
		{title: 'Slow Cooker Creamy Tomato Basil Tortellini Soup', url: 'https://www.cookingclassy.com/slow-cooker-creamy-tomato-basil-tortellini-soup/'}),
		$author$project$Main$Recipe(
		{title: 'Steak Bites with Sweet Potatoes and Peppers', url: 'https://oursaltykitchen.com/whole30-steak-bites/#recipe'}),
		$author$project$Main$Recipe(
		{title: 'Stuffed Pepper Soup', url: 'https://www.paleorunningmomma.com/stuffed-pepper-soup-instant-pot-whole30/'}),
		$author$project$Main$Recipe(
...
var $pablohirafuji$elm_qrcode$QRCode$defaultImageOptions = {darkColor: 255, lightColor: 4294967295, moduleSize: 5, quietZoneSize: 4};
...
var $justgook$elm_image$Image$Internal$Meta$FromDataBitDepth8 = {$: 'FromDataBitDepth8'};
var $justgook$elm_image$Image$Internal$Meta$FromDataChannel4 = function (a) {
	return {$: 'FromDataChannel4', a: a};
};
...
var $justgook$elm_image$Image$fromList2d = function (l) {
	return A2(
		...
		$justgook$elm_image$Image$Internal$Meta$FromData(
			{
				color: $justgook$elm_image$Image$Internal$Meta$FromDataChannel4($justgook$elm_image$Image$Internal$Meta$FromDataBitDepth8),
				height: $elm$core$List$length(l),
				width: A2(
					$elm$core$Maybe$withDefault,
					0,
					A2(
...
var $pablohirafuji$elm_qrcode$QRCode$Render$Raster$moduleToPixel = F2(
	function (options, isDark) {
		return isDark ? options.darkColor : options.lightColor;
	});
var $pablohirafuji$elm_qrcode$QRCode$Render$Raster$toImageWithOptions = F2(
	function (options, matrix) {
		var moduleSize = A2($elm$core$Basics$max, 1, options.moduleSize);
				...
				A2(
					...
					A2(
						...
						A2(
							...
							$elm$core$List$concat,
							$elm$core$List$repeat(moduleSize))),
					A2($pablohirafuji$elm_qrcode$QRCode$Render$Raster$addQuietZone, options.quietZoneSize, matrix))));
	});
...
var $pablohirafuji$elm_qrcode$QRCode$toImage = $pablohirafuji$elm_qrcode$QRCode$toImageWithOptions($pablohirafuji$elm_qrcode$QRCode$defaultImageOptions);
...
var $justgook$elm_image$Image$Internal$ImageData$RGBA = {$: 'RGBA'};
var $justgook$elm_image$Image$Internal$ImageData$RightDown = {$: 'RightDown'};
var $justgook$elm_image$Image$Internal$ImageData$defaultOptions = {format: $justgook$elm_image$Image$Internal$ImageData$RGBA, order: $justgook$elm_image$Image$Internal$ImageData$RightDown};
...
var $justgook$elm_image$Image$Internal$PNG$encodeChunk = F2(
	function (kind, data) {
		...
		return $elm$bytes$Bytes$Encode$sequence(
			_List_fromArray(
				[
					A2($elm$bytes$Bytes$Encode$unsignedInt32, $elm$bytes$Bytes$BE, length),
...
var $justgook$elm_image$Image$Internal$PNG$encodeIHDR = F3(
	function (width, height, _v0) {
		...
		return $elm$bytes$Bytes$Encode$sequence(
			_List_fromArray(
				[
					A2($elm$bytes$Bytes$Encode$unsignedInt32, $elm$bytes$Bytes$BE, width),
					A2($elm$bytes$Bytes$Encode$unsignedInt32, $elm$bytes$Bytes$BE, height),
...
var $justgook$elm_image$Image$Internal$Pixel$toBit32 = function (image) {
	...
	switch (_v0.$) {
		...
		case 'Bmp':
			var bitsPerPixel = _v0.a.bitsPerPixel;
			switch (bitsPerPixel.$) {
				case 'BmpBitsPerPixel8':
		...
		default:
			var color = _v0.a.color;
			switch (color.$) {
				case 'FromDataChannel1':
					return image;
				case 'FromDataChannel2':
					return image;
				case 'FromDataChannel3':
					return image;
				default:
					return image;
			}
...
var $author$project$Main$viewQRCode = function (message) {
	return A2(
					...
					_List_fromArray(
						[
							...
							$justgook$elm_image$Image$toPngUrl(
								$pablohirafuji$elm_qrcode$QRCode$toImage(qrCode))),
							$elm$html$Html$Attributes$class('qr-code')
						]),
					_List_Nil);
			},
			$pablohirafuji$elm_qrcode$QRCode$fromString(message)));
};
var $author$project$Main$toItem = function (recipe) {
	var r = recipe.a;
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('recipe-item')
			]),
		_List_fromArray(
			[
				A2(
				...
				$author$project$Main$viewQRCode(r.url)
			]));
};
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Main$toSection = function (section) {
	var s = section.a;
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('recipe-list')
					]),
				A2($elm$core$List$map, $author$project$Main$toItem, s.recipes))
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$toSection, model));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$initSections, update: $author$project$Main$update, view: $author$project$Main$view});
